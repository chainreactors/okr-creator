...
我们对 okr-creator 这个项目运行了 `/okr:create`，它给自己做了六维诊断：
...
![每日评估 Issue](screenshots/02-issue-okr-review.png)
...
只要你的项目有 README 和目录结构，`/okr:create` 就能分析出来该往哪走。
